...
import { useGetAnomaliesQuery, useResolveAnomalyMutation } from "@/lib/redux/query";
    ...
    return (
        <main className="p-8 space-y-8 animate-in fade-in duration-700">
            ...
            <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight text-gray-900">System-Wide Anomalies</h1>
                <p className="text-gray-500">Monitor and manage anomalies across all solar units.</p>
            </div>
                                            ...
                                            {anomaly.solarUnitId && (
                                                <>
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        {anomaly.solarUnitId.serialNumber || "Unknown Unit"}
                                                    </div>
                                                    {anomaly.solarUnitId.userId && (
                                                        <div className="flex items-center gap-1 text-blue-600">
                                                            <span className="font-medium">
                                                                {anomaly.solarUnitId.userId.firstName} {anomaly.solarUnitId.userId.lastName}
                                                            </span>
                                                        </div>
                                                    )}
                                                </>
